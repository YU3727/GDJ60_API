...
//230109 Collection Framework - List 7교시
	public static void main(String[] args) {
		...
		//원래 과정 : Integer num1 = new Integer(1); ar.add(num1);
		//int1(primitive type)이 Integer1(reference type)로 변환 -> Object type은 모든 reference type
		//의 부모클래스이므로, 다형성이 성립됨. -> Integer타입이 object 타입으로 변환되어 저장됨.
		...
		//ArrayList에 담겨있는 데이터 타입이 뒤죽박죽이라 꺼낼때 주의해야함.
